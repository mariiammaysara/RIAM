...
export default function RiamDashboard() {
    ...
    const [activeTab, setActiveTab] = useState<"agents" | "knowledge" | "inbox">("agents");
    ...
    useEffect(() => {
        const handleEsc = (e: KeyboardEvent) => {
            if (e.key === "Escape" || e.keyCode === 27) {
                console.log("RIAM Dashboard: Escape key pressed, resetting states");
    ...
    const handleHumanReply = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${backendUrl}/api/v1/conversations/${selectedConversation.id}`, {
                method: "PATCH",
                headers: authHeaders,
                body: JSON.stringify({ status: "handoff" }) // Keep/set in handoff so AI remains paused
            });
                ...
                <div className="p-6 md:p-3 lg:p-6 group-hover:md:p-6 transition-all duration-300 overflow-hidden">
                    ...
                    <nav className="space-y-1">
                        <button
                            ...
                            className={`w-full flex items-center space-x-3 px-4 py-3.5 md:px-1.5 md:py-2.5 lg:px-4 lg:py-3.5 group-hover:md:px-4 group-hover:md:py-3.5 text-xs font-medium tracking-wide transition-all duration-300 border-l-2 min-h-[44px] ${activeTab === "agents" ? "border-[#7c6af7] bg-[#7c6af7]/5 text-[#e2e8f0]" : "border-transparent text-[#8892a4] hover:text-[#e2e8f0]"}`}
                        >
                        ...
                        <button
                            ...
                            className={`w-full flex items-center space-x-3 px-4 py-3.5 md:px-1.5 md:py-2.5 lg:px-4 lg:py-3.5 group-hover:md:px-4 group-hover:md:py-3.5 text-xs font-medium tracking-wide transition-all duration-300 border-l-2 min-h-[44px] ${activeTab === "knowledge" ? "border-[#7c6af7] bg-[#7c6af7]/5 text-[#e2e8f0]" : "border-transparent text-[#8892a4] hover:text-[#e2e8f0]"}`}
                        >
                            <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                        ...
                        <button
                            ...
                            className={`w-full flex items-center space-x-3 px-4 py-3.5 md:px-1.5 md:py-2.5 lg:px-4 lg:py-3.5 group-hover:md:px-4 group-hover:md:py-3.5 text-xs font-medium tracking-wide transition-all duration-300 border-l-2 min-h-[44px] ${activeTab === "inbox" ? "border-[#7c6af7] bg-[#7c6af7]/5 text-[#e2e8f0]" : "border-transparent text-[#8892a4] hover:text-[#e2e8f0]"}`}
                        >
                            <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                ...
                <header className="h-16 border-b border-[#1e2330] px-4 md:px-8 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <h2 className="text-[10px] uppercase tracking-[0.2em] font-medium text-[#8892a4] truncate">
                            {activeTab === "agents" ? "AI Agents Designer" : activeTab === "knowledge" ? "Knowledge Hub & Vectors" : "Inbox Live Operator Console"}
                        </h2>
                    </div>
                                    ...
                                    <div className="space-y-2">
                                        {agents.map((ag, index) => (
                                            ...
                                            >
                                                ...
                                                <span 
                                                    className="w-2.5 h-2.5 rounded-full border border-[#1e2330] shrink-0"
